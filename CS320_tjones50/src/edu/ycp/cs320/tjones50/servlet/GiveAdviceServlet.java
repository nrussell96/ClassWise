...
public class GiveAdviceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// get the courseName and departmentName from the previous servlet
		// (course servlet)
		String courseName = req.getParameter("courseName");
		String departmentName = req.getParameter("departmentName");

		// Stores the given department and course from the course, so it can be
		// displayed on the give advice page
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// The code below may be used for making an error message on the give
		// advice page
		...
		//
		// if (approved == null || difficulty == null || instruction == null ||
		// suppliesCost == null || enjoyment == null || gradeReceived == null ||
		// flags == null || semester == null || classYear == null || text ==
		// null) {
		...
		// Use data from user's advice from give advice page and create a new
		// piece of advice, then add it to the advice list
