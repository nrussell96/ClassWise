...
public class UserAccountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		Advice advice = new Advice(adviceRating, model.getUserClassYear(), model.getMajor(), model.getGPA(), 4.0, "Spring", 2017);
		...
		Advice advice2 = new Advice(adviceRating2, model.getUserClassYear(), model.getMajor(), model.getGPA(), 2.0, "Summer", 2017);
		...
		Advice advice3 = new Advice(adviceRating3, model.getUserClassYear(), model.getMajor(), model.getGPA(), 3.5, "Fall", 2016);
